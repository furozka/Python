...
#stack plot değerleri ekleyerek üst üste çizer
...
# Pie Grafiği çeberde yüzdelik dilimlerle gösterim
...
# Bar Grafiği birinci değerler barlrın merkez noktaları widthlerde kalınlıkları ikinci değerler yükseklikleri
...
# Histogram belli yas gruplarındaki kişi sayıları
